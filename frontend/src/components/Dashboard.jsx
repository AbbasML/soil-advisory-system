...
const cropData =
  ...
  doc.text(
    `Soil Health Score: ${analysis.soil_health_score}/100`,
    20,
    40
  );

  doc.text(
    `Soil Status: ${analysis.soil_health_status}`,
    20,
    50
  );

  doc.text(
    `Recommended Crop: ${analysis.crop}`,
    20,
    60
  );
  ...
  doc.text(
    `Deficiencies: ${
      analysis.deficiencies.join(", ") || "None"
    }`,
    20,
    120
  );
  ...
  doc.text(
    `Generated by AI Soil Health Advisory System`,
    20,
    260
  );
...
<div className="card">
  ...
  <p>
    Current Score: {analysis.soil_health_score}/100
  </p>
</div>
